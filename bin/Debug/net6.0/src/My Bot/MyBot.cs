...
public class MyBot : IChessBot
{
    ...
    //afegir hakes al sort millorar lo de king endgame i fer la meva propia millorar la eval d'alguna forma intenta buscar una forma millor que la classe foo;
